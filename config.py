...
BOT_USERNAME = getenv("BOT_USERNAME", "@Ard_MMusic_Bot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "Ard Mast Music")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "Ard MM assi")
EVALOP = list(map(int, getenv("EVALOP", "7178341913").split()))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ArdNeriw/ARD_ASTHE_MUSIC",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv(
    "GIT_TOKEN", None)  # Fill this variable if your upstream repository is private

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Ard_mm_support")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Ard_mm_support")
